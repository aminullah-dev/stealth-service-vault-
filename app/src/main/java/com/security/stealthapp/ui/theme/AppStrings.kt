...
class AppStrings {
    ...
    // Disguise notepad (the cover app) — fully localized so it looks native.
    var notepadTitle: String = ""
    var notepadSearchHint: String = ""
    var notepadNewNote: String = ""
    var notepadNoteTitleHint: String = ""
    var notepadCreate: String = ""
    var notepadSortByDate: String = ""
    var notepadNewAccount: String = ""
    var notepadBack: String = ""
    var notepadDelete: String = ""
    var notepadUntitled: String = ""
    var notepadEmpty: String = ""
    var notepadSeed1Title: String = ""
    var notepadSeed1Body: String = ""
    var notepadSeed2Title: String = ""
    var notepadSeed2Body: String = ""
    var notepadSeed3Title: String = ""
    var notepadSeed3Body: String = ""
...
object StringResources {
    ...
    val ENGLISH = AppStrings().apply {
        ...
        notepadTitle               = "My Notes"
        notepadSearchHint          = "Search notes…"
        notepadNewNote             = "New Note"
        notepadNoteTitleHint       = "Note title"
        notepadCreate              = "Create"
        notepadSortByDate          = "Sort by date"
        notepadNewAccount          = "New account"
        notepadBack                = "Notes"
        notepadDelete              = "Delete"
        notepadUntitled            = "Untitled"
        notepadEmpty               = "No notes yet. Tap + to create one."
        notepadSeed1Title          = "Grocery List"
        notepadSeed1Body           = "Tomatoes, onions, naan, yogurt, rice, lentils, cooking oil, tea, sugar."
        notepadSeed2Title          = "Reminders"
        notepadSeed2Body           = "- Pick up package from the post office\n- Pay the electricity bill before the 20th\n- Call the doctor for an appointment"
        notepadSeed3Title          = "Monthly Budget"
        notepadSeed3Body           = "Rent: 8,000\nFood: 4,000\nSchool fees: 1,500\nTransport: 800"
    ...
    val DARI = AppStrings().apply {
        ...
        notepadTitle               = "یادداشت‌های من"
        notepadSearchHint          = "جستجوی یادداشت‌ها…"
        notepadNewNote             = "یادداشت جدید"
        notepadNoteTitleHint       = "عنوان یادداشت"
        notepadCreate              = "ایجاد"
        notepadSortByDate          = "مرتب‌سازی بر اساس تاریخ"
        notepadNewAccount          = "حساب جدید"
        notepadBack                = "یادداشت‌ها"
        notepadDelete              = "حذف"
        notepadUntitled            = "بدون عنوان"
        notepadEmpty               = "هنوز یادداشتی نیست. برای ایجاد روی + بزنید."
        notepadSeed1Title          = "لیست خرید"
        notepadSeed1Body           = "بادنجان رومی، پیاز، نان، ماست، برنج، عدس، روغن، چای، بوره."
        notepadSeed2Title          = "یادآوری‌ها"
        notepadSeed2Body           = "- گرفتن بسته از پست‌خانه\n- پرداخت بل برق پیش از ۲۰\n- تماس با داکتر برای وقت ملاقات"
        notepadSeed3Title          = "بودجه ماهانه"
        notepadSeed3Body           = "کرایه: ۸۰۰۰\nغذا: ۴۰۰۰\nفیس مکتب: ۱۵۰۰\nترانسپورت: ۸۰۰"
    ...
    val PASHTO = AppStrings().apply {
        ...
        notepadTitle               = "زما یادښتونه"
        notepadSearchHint          = "د یادښتونو لټون…"
        notepadNewNote             = "نوی یادښت"
        notepadNoteTitleHint       = "د یادښت سرلیک"
        notepadCreate              = "جوړول"
        notepadSortByDate          = "د نیټې له مخې ترتیب"
        notepadNewAccount          = "نوی حساب"
        notepadBack                = "یادښتونه"
        notepadDelete              = "ړنګول"
        notepadUntitled            = "بې سرلیکه"
        notepadEmpty               = "تر اوسه هیڅ یادښت نشته. د جوړولو لپاره + کېکاږئ."
        notepadSeed1Title          = "د بازار لیست"
        notepadSeed1Body           = "رومي بانجن، پیاز، ډوډۍ، مستې، وريجې، دال، تېل، چای، بوره."
        notepadSeed2Title          = "یادونې"
        notepadSeed2Body           = "- له پوستې څخه د بستې اخیستل\n- د ۲۰ مخکې د بریښنا بل ورکول\n- د ملاقات لپاره ډاکټر ته زنګ"
        notepadSeed3Title          = "میاشتنۍ بودیجه"
        notepadSeed3Body           = "کرایه: ۸۰۰۰\nخواړه: ۴۰۰۰\nد ښوونځي فیس: ۱۵۰۰\nترانسپورت: ۸۰۰"
