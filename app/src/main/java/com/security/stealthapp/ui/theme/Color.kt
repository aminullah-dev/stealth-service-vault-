...
// ── Disguise / Notepad palette ────────────────────────────────────────────────
val NotepadBg         = Color(0xFFFFFDE7)
val NotepadSurface    = Color(0xFFFFF9C4)
val NotepadPrimary    = Color(0xFF5D4037)
val NotepadSecondary  = Color(0xFF795548)
val NotepadLines      = Color(0xFFE0E0E0)
val NotepadOnPrimary  = Color(0xFFFFFFFF)

// ── Hidden Dashboard palette ─────────────────────────────────────────────────
