...
object StringResources {
    ...
    val ENGLISH = AppStrings().apply {
        ...
        feedTitle                  = "Discover"
        feedEmpty                  = "No posts yet. Follow salons to see their latest work here."
    ...
    val DARI = AppStrings().apply {
        ...
        feedTitle                  = "کشف"
        feedEmpty                  = "هنوز پستی نیست. سالن‌ها را دنبال کنید تا آخرین کارهایشان اینجا بیاید."
    ...
    val PASHTO = AppStrings().apply {
        ...
        feedTitle                  = "کشف"
        feedEmpty                  = "تر اوسه پوسټ نشته. سالونونه تعقیب کړئ چې دلته یې وروستي کارونه ووینئ."
