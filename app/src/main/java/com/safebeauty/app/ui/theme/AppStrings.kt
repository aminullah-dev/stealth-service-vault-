...
object StringResources {
    ...
    val DARI = AppStrings().apply {
        ...
        bookFailMustPrepay         = "این رزرو باید از پیش پرداخت شود. سالن یک صندلی را برای شما نگه می‌دارد، و رزروی که پولش پرداخت نشده صندلی‌ای است که نمی‌توانند به کس دیگری بدهند."
        bookFailPartyPrepay        = "رزرو گروهی از پیش پرداخت می‌شود. سالن تمام تیمش را برای شما کنار می‌گذارد، پس آن روز صندلی‌ای برای کس دیگری ندارد."
