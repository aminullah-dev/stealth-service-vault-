...
class AppStrings {
    ...
    // Reporting and blocking. The app carries salon photos, stories, customer
    // comments and customer reviews and had no way to report any of it — which
    // is a Play policy problem for user-generated content before it is anything
    // else, and before that a woman with no recourse.
    // A customer saying what happened at a visit — the mirror of reportCustomer,
    // which has pointed the other way since this shipped.
    var reportVisitTitle: String = ""
    var reportVisitAction: String = ""
    var reportVisitWhy: String = ""
    var visitNotServed: String = ""
    var visitTurnedAway: String = ""
    var visitDifferentService: String = ""
    var visitOvercharged: String = ""
    var visitSafety: String = ""
    var reportVisitSentTitle: String = ""
    var reportVisitSentBody: String = ""
    var reportTitle: String = ""
    var reportAction: String = ""
    var reportWhy: String = ""
    var reportHarassment: String = ""
    var reportNudity: String = ""
    var reportHate: String = ""
    var reportScam: String = ""
    var reportSpam: String = ""
    var reportOther: String = ""
    var reportNotePlaceholder: String = ""
    var reportSubmit: String = ""
    var reportAlsoBlock: String = ""
    var reportAlsoBlockHint: String = ""
    var reportSentTitle: String = ""
    var reportSentBody: String = ""
    var unblockAction: String = ""
    var blockedTitle: String = ""
    var blockedEmpty: String = ""
    var blockedHidden: String = ""
    ...
    var regRegisteredNowSignIn: String = ""
...
object StringResources {
    ...
    val ENGLISH = AppStrings().apply {
        ...
        reportVisitTitle           = "Report this visit"
        reportVisitAction          = "Something went wrong?"
        reportVisitWhy             = "What happened?"
        visitNotServed             = "I went and was not served"
        visitTurnedAway            = "They turned me away"
        visitDifferentService      = "I was given a different service"
        visitOvercharged           = "I was asked to pay more than agreed"
        visitSafety                = "I was treated badly"
        reportVisitSentTitle       = "Report received"
        reportVisitSentBody        = "The SafeBeauty team will look into it, and refund you if money is owed back. The salon does not hear your name from us."
        reportTitle                = "Report content"
        reportAction               = "Report"
        reportWhy                  = "What is wrong with it?"
        reportHarassment           = "Harassment or abuse"
        reportNudity               = "Nudity or sexual content"
        reportHate                 = "Hate speech"
        reportScam                 = "Scam or fraud"
        reportSpam                 = "Spam"
        reportOther                = "Something else"
        reportNotePlaceholder      = "Tell us more, if you want to (optional)"
        reportSubmit               = "Send report"
        reportAlsoBlock            = "Also block this account"
        reportAlsoBlockHint        = "You will not see anything from them again."
        reportSentTitle            = "Report received"
        reportSentBody             = "The SafeBeauty team reviews it within 24 hours. Your name is never shared."
        unblockAction              = "Unblock"
        blockedTitle               = "Blocked accounts"
        blockedEmpty               = "You have not blocked anyone."
        blockedHidden              = "Content from a blocked account is hidden."
        ...
        setNewPinHalfDone          = "Your password was changed, but the app could not finish. Your old password no longer works. Request a new reset link and set the password again."
        ...
        regRegisteredNowSignIn     = "Your account was created. Sign in with your phone number and password."
    ...
    val DARI = AppStrings().apply {
        ...
        reportVisitTitle           = "گزارش این نوبت"
        reportVisitAction          = "مشکلی پیش آمد؟"
        reportVisitWhy             = "چه اتفاقی افتاد؟"
        visitNotServed             = "رفتم ولی خدمتی نگرفتم"
        visitTurnedAway            = "مرا نپذیرفتند"
        visitDifferentService      = "خدمت دیگری به من دادند"
        visitOvercharged           = "بیشتر از قیمت توافق‌شده خواستند"
        visitSafety                = "با من بد رفتار شد"
        reportVisitSentTitle       = "گزارش شما رسید"
        reportVisitSentBody        = "تیم SafeBeauty آن را بررسی می‌کند و اگر پولی برگشتنی باشد، برمی‌گردانیم. سالن نام شما را از ما نمی‌شنود."
        reportTitle                = "گزارش محتوا"
        reportAction               = "گزارش"
        reportWhy                  = "مشکل چیست؟"
        reportHarassment           = "آزار و توهین"
        reportNudity               = "محتوای غیراخلاقی"
        reportHate                 = "نفرت‌پراکنی"
        reportScam                 = "کلاهبرداری"
        reportSpam                 = "تبلیغ ناخواسته"
        reportOther                = "چیز دیگر"
        reportNotePlaceholder      = "اگر می‌خواهید توضیح بدهید (اختیاری)"
        reportSubmit               = "فرستادن گزارش"
        reportAlsoBlock            = "این حساب را هم مسدود کن"
        reportAlsoBlockHint        = "دیگر هیچ نوشته و عکسی از او نمی‌بینید."
        reportSentTitle            = "گزارش شما رسید"
        reportSentBody             = "تیم SafeBeauty در کمتر از ۲۴ ساعت آن را بررسی می‌کند. نام شما به کسی گفته نمی‌شود."
        unblockAction              = "رفع مسدودی"
        blockedTitle               = "حساب‌های مسدودشده"
        blockedEmpty               = "کسی را مسدود نکرده‌اید."
        blockedHidden              = "محتوای یک حساب مسدودشده پنهان شد."
        ...
        setNewPinHalfDone          = "رمز شما عوض شد، اما کار تا آخر پیش نرفت. رمز قبلی دیگر کار نمی‌کند. یک لینک بازنشانی تازه بگیرید و رمز را دوباره تعیین کنید."
        ...
        regRegisteredNowSignIn     = "حساب شما ساخته شد. با شماره و رمز عبور خود وارد شوید."
    ...
    val PASHTO = AppStrings().apply {
        ...
        reportVisitTitle           = "د دې نوبت راپور"
        reportVisitAction          = "کومه ستونزه وشوه؟"
        reportVisitWhy             = "څه پېښ شول؟"
        visitNotServed             = "ورغلم خو خدمت رانه نکړ"
        visitTurnedAway            = "ما یې ونه منله"
        visitDifferentService      = "بل خدمت یې راکړ"
        visitOvercharged           = "له هوکړه شوې بیې زیات یې وغوښتل"
        visitSafety                = "زما سره بد چلند وشو"
        reportVisitSentTitle       = "ستاسو راپور ورسېد"
        reportVisitSentBody        = "د SafeBeauty ټیم به یې وګوري او که پیسې بیرته کېدونکې وي، بیرته به یې درکړو. سالون به ستاسو نوم زموږ له خوا وا نه وري."
        reportTitle                = "د محتوا راپور"
        reportAction               = "راپور"
        reportWhy                  = "ستونزه څه ده؟"
        reportHarassment           = "ځورونه او سپکاوی"
        reportNudity               = "غیراخلاقي محتوا"
        reportHate                 = "کرکه خپرول"
        reportScam                 = "درغلي"
        reportSpam                 = "ناغوښتی اعلان"
        reportOther                = "بل څه"
        reportNotePlaceholder      = "که غواړئ تشریح یې کړئ (اختیاري)"
        reportSubmit               = "راپور لېږل"
        reportAlsoBlock            = "دا حساب هم بند کړه"
        reportAlsoBlockHint        = "نور به یې هیڅ لیکنه او عکس ونه وینئ."
        reportSentTitle            = "ستاسو راپور ورسېد"
        reportSentBody             = "د SafeBeauty ټیم به یې په ۲۴ ساعتونو کې وګوري. ستاسو نوم هیچا ته نه ویل کیږي."
        unblockAction              = "بند لرې کول"
        blockedTitle               = "بند شوي حسابونه"
        blockedEmpty               = "تاسو څوک نه دي بند کړي."
        blockedHidden              = "د یو بند شوي حساب محتوا پټه شوه."
        ...
        setNewPinHalfDone          = "ستاسو پټنوم بدل شو، خو کار پای ته ونه رسېد. پخوانی پټنوم نور کار نه کوي. د بیا تنظیم کولو نوی لینک واخلئ او پټنوم بیا وټاکئ."
        ...
        regRegisteredNowSignIn     = "ستاسو حساب جوړ شو. په خپله شمېره او پټنوم سره ننوځئ."
